    ...
    <>
      ...
      <main style={{ backgroundColor: 'var(--color-dark, #131924)', color: 'white', overflowX: 'hidden' }}>
        ...
        {/* =======================================================
           ...
           ======================================================= */}
        <section className="hero section reveal" style={{ paddingTop: '180px', paddingBottom: '60px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div className="container hero-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '40px', width: '100%', maxWidth: '1300px', margin: '0 auto', padding: '0 16px', alignItems: 'center' }}>
            ...
            <div className="hero-text" style={{ textAlign: 'left' }}>              
              ...
              <p style={{ color: 'var(--color-text-medium, #8892b0)', fontSize: 'clamp(0.9rem, 2.5vw, 1.15rem)', lineHeight: '1.6', marginBottom: '30px', maxWidth: '550px' }}>
        ...
        <section className="features section reveal" style={{ padding: '60px 0', borderTop: '1px solid rgba(255,255,255,0.03)' }}>
          <div className="container features-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '40px', width: '100%', maxWidth: '1300px', margin: '0 auto', padding: '0 16px', alignItems: 'center' }}>
            ...
            <div className="features-list" style={{ display: 'flex', flexDirection: 'column', gap: '20px', textAlign: 'left' }}>
              ...
              <div style={{ display: 'flex', gap: '15px', backgroundColor: 'rgba(255,255,255,0.02)', padding: '20px', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.04)' }}>
                <div style={{ fontSize: '1.5rem', color: '#faad14', marginTop: '3px', flexShrink: 0 }}><FaShieldAlt /></div>
                <div>
                  <h3 style={{ fontSize: 'clamp(0.95rem, 2vw, 1.1rem)', fontWeight: '600', margin: '0 0 6px 0' }}>Cifrado AES-256 local</h3>
                  <p style={{ color: 'var(--color-text-medium, #8892b0)', fontSize: 'clamp(0.8rem, 2vw, 0.9rem)', margin: 0, lineHeight: '1.5' }}>Tus archivos se encriptan simétricamente en el cliente antes de ser transferidos.</p>
                </div>
              </div>

              {/* Tarjeta 2 */}
              <div style={{ display: 'flex', gap: '15px', backgroundColor: 'rgba(255,255,255,0.02)', padding: '20px', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.04)' }}>
                <div style={{ fontSize: '1.5rem', color: '#0a3fff', marginTop: '3px', flexShrink: 0 }}><FaUserLock /></div>
                <div>
                  <h3 style={{ fontSize: 'clamp(0.95rem, 2vw, 1.1rem)', fontWeight: '600', margin: '0 0 6px 0' }}>Autenticación por Correo</h3>
                  <p style={{ color: 'var(--color-text-medium, #8892b0)', fontSize: 'clamp(0.8rem, 2vw, 0.9rem)', margin: 0, lineHeight: '1.5' }}>Agrega un token de un solo uso.</p>
                </div>
              </div>

              {/* Tarjeta 3 */}
              <div style={{ display: 'flex', gap: '15px', backgroundColor: 'rgba(255,255,255,0.02)', padding: '20px', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.04)' }}>
                <div style={{ fontSize: '1.5rem', color: '#52c41a', marginTop: '3px', flexShrink: 0 }}><FaKey /></div>
                <div>
                  <h3 style={{ fontSize: 'clamp(0.95rem, 2vw, 1.1rem)', fontWeight: '600', margin: '0 0 6px 0' }}>Políticas de Acceso Robustas</h3>
                  <p style={{ color: 'var(--color-text-medium, #8892b0)', fontSize: 'clamp(0.8rem, 2vw, 0.9rem)', margin: 0, lineHeight: '1.5' }}>Configura restricciones avanzadas decidiendo entre permisos de descarga completa o solo lectura (vista previa).</p>
                </div>
              </div>
          ...
          <div className="container" style={{ width: '100%', maxWidth: '1300px', margin: '0 auto', padding: '0 16px' }}>
            ...
            <div className="steps-grid card-glow-plop" style={{ 
              ...
              <article className="step-card" style={{ textAlign: 'center' }}>
                <div style={{ width: '45px', height: '45px', borderRadius: '50%', backgroundColor: 'var(--color-dark)', border: '2px solid var(--color-accent)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 15px', fontWeight: '700', fontSize: '1.2rem', color: 'var(--color-accent)' }}>
          ...
          <div className="container" style={{ width: '100%', maxWidth: '1300px', margin: '0 auto', padding: '0 16px' }}>
            ...
            <div className="benefits-grid card-glow-plop" style={{ 
              ...
              <article className="benefit-box" style={{ textAlign: 'left' }}>
                <h4 style={{ margin: '0 0 8px 0', fontSize: 'clamp(0.95rem, 2vw, 1.1rem)', color: 'var(--color-accent)' }}>Auditoría e Historial</h4>
              ...
              <article className="benefit-box" style={{ textAlign: 'left' }}>
                <h4 style={{ margin: '0 0 8px 0', fontSize: 'clamp(0.95rem, 2vw, 1.1rem)', color: 'var(--color-accent)' }}>Clasificación por Nivel</h4>
              ...
              <article className="benefit-box" style={{ textAlign: 'left' }}>
                <h4 style={{ margin: '0 0 8px 0', fontSize: 'clamp(0.95rem, 2vw, 1.1rem)', color: 'var(--color-accent)' }}>Control Inbound / Outbound</h4>
        ...
        <section className="cta section reveal" style={{ padding: '40px 0 80px 0' }}>
          <div className="container" style={{ width: '100%', maxWidth: '1300px', margin: '0 auto', padding: '0 16px' }}>
            ...
            <div className="cta-box card-glow-plop" style={{ 
              ...
              <div>
                <h2 style={{ margin: 0, fontSize: 'clamp(1.2rem, 4vw, 1.6rem)', fontWeight: '700' }}>Empieza a proteger tus archivos hoy</h2>
                <p style={{ margin: '8px 0 0 0', color: 'var(--color-text-medium)', fontSize: 'clamp(0.85rem, 2.5vw, 0.95rem)' }}>Crea una cuenta y comienza a usar una plataforma confiable para gestionar tu información.</p>
              </div>
              <div className="cta-actions" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px' }}>
                <Link to="/registro" className="btn btn-primary" style={{ padding: 'clamp(10px 20px, 2vw, 12px 30px)', fontWeight: 'bold', fontSize: 'clamp(0.85rem, 2vw, 1rem)' }}>Crear cuenta</Link>
